...
function evensOnly (){
  return myNumbers.filter(function(x){return (x%2==0)});
};
...
var trueFriends = peopleIknow.filter(function(o){ return o.friend==true})
...
function indexFinder(){
  ...
  return randomNumbers.map(function (value, index, array) {return index})
}
